  ...
  return (
    <div className="timeline-global-container">
      ...
      <nav className="global-header-nav">
        <div className="nav-brand">Peradaban Kuno</div>
        <div className="nav-links">
          <button onClick={() => onNavigate('mesir')}>Beranda</button>
          <button onClick={() => onNavigate('mesir')}>Peradaban</button>
          <button className="active" onClick={() => onNavigate('timeline')}>Timeline</button>
          <button onClick={() => onNavigate('romawi')}>Warisan</button>
        </div>
        <button className="explore-btn" onClick={() => onNavigate('mesir')}>Mulai Jelajah</button>
      </nav>
